...
namespace ROOT {
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::PrtclData*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::PrtclEvent*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::PrtclData*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::PrtclEvent*)0x0)->GetClass(); }
   return fgIsA;
}
...
"./include",
"/home/user/install/root/include",
"/home/user/work/CMS/gen_handle/events/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PrtclDct",
        ...
        TriggerDictionaryInitialization_PrtclDct_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
